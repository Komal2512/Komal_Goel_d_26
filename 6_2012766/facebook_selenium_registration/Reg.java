...
public class fbregistration {
  ...
  public void f() {
    ...
    driver.findElement(By.xpath("//*[@value='First Name']")).sendKeys("Komal");
    driver.findElement(By.xpath("//*[@value='Last Name']")).sendKeys("Goel");
   
    driver.findElement(By.id("u_0_5")).sendKeys("komalgoel@gmail.com");
   
    driver.findElement(By.id("u_0_8")).sendKeys("komalgoel@mail.com");
    driver.findElement(By.id("u_0_a")).sendKeys("komal2244");
